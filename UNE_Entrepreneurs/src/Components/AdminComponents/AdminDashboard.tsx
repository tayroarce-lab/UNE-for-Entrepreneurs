...
import { LayoutDashboard, Users, Banknote, Newspaper, Settings, LogOut, BarChart3, Map, UserCircle } from 'lucide-react'
...
function AdminDashboard() {
  const [perfilImg] = useState<string | null>(localStorage.getItem('adminProfileImg') || null);
    ...
    <div className="admin-container">
      <nav>
        ...
        <ul>
          ...
          <li><a href="/MapaSucursales"><Map size={18} /> Mapa Sede</a></li>
      ...
      <header>
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '15px' }}>
          {perfilImg ? (
            <img src={perfilImg} alt="Perfil" style={{ width: '40px', height: '40px', borderRadius: '50%', objectFit: 'cover', border: '2px solid #fff' }} />
          ) : (
