...
const casosDeExito: SuccessCase[] = [
  { id: 1, nombre: 'Damaris', profesion: 'Artesana', ubicacion: 'Emprendedora', cita: 'Confiaron en mí, en mi capacidad, y lo más bonito es ver cómo se realizan mis sueños, ver mi taller creciendo gracias a las oportunidades que nos han dado.', imagen: damarisImg, colorTag: '#60a5fa' },
  { id: 2, nombre: 'Ginette', profesion: 'Artesana', ubicacion: 'Emprendedora', cita: 'A mí esto me ha abierto mucho los ojos. Ahora entiendo que si quiero que mi negocio crezca tengo que ordenarme.', imagen: ginetteImg, colorTag: '#4ade80' },
  { id: 3, nombre: 'Katherine', profesion: 'Panadera', ubicacion: 'Emprendedora', cita: 'Esta ha sido una experiencia muy bonita, con compañeras muy buenas y una guía que está siempre presente.', imagen: katherineImg, colorTag: '#f472b6' },
  { id: 4, nombre: 'Marielos', profesion: 'Cocinera', ubicacion: 'Bagaces', cita: 'Hoy estamos de fiesta por saber que las mujeres de Bagaces fueron escuchadas por UNE.', imagen: marielosImg, colorTag: '#facc15' },
];
